...
class DatabaseHandler {
  ...
  void _createDb(Database db, int version) async {
    await db.execute(
        'CREATE TABLE SONGS ( SONG_ID PRIMARY KEY, CATEGORY TEXT, SONG_URL TEXT, NAME TEXT, TYPE TEXT, SUB TEXT, COVER_URL TEXT, INSERT_TIME INTEGER )');
    await db.execute(
        'CREATE TABLE CATEGORIES ( CATEGORY_ID PRIMARY KEY, CATEGORY TEXT, IMAGE_URL TEXT )');
  }
